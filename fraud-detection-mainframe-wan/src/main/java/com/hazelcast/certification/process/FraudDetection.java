...
public abstract class FraudDetection {
	...
	final protected void registerResult(RulesResult rulesResult) {
		if(isValidResult(rulesResult)) {
			tpsCounter.incrementAndGet();
		}
	}

	private boolean isValidResult(RulesResult rulesResult) {
		return rulesResult.getTransactionID() != null;
	}
