...
public class HistoricalTxnsLoaderImpl implements HistoricalTransactionsLoader {
	...
	private class Loader implements Runnable{
		...
		public void run() {
//			int putAllCounter = 0;
//			Map<String, List<TransactionDB>> localMap = new HashMap<String, List<TransactionDB>>();
//			TransactionUtil txnUtil = new TransactionUtil();
//			for (int i = start; i < end; i++) {
//				String creditCardNumber = txnUtil.generateCreditCardNumber(i);
//				List<TransactionDB> cardTxns = txnUtil.createAndGetCreditCardTransactions(creditCardNumber, TRANSACTIONS_PER_CARD);
